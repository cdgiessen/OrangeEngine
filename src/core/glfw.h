...
class InputDirector
{
	...
	Vec2f get_mouse_change_in_position() const;
	...
	struct InputFrame
	{
		...
		Vec2f mouse_positionPrevious = Vec2f{ 0.0f, 0.0f };
		Vec2f mouse_changeInPosition = Vec2f{ 0.0f, 0.0f };
		Vec2f mouse_scroll = Vec2f{ 0.0f, 0.0f };
